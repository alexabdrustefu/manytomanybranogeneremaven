...
//			testEstraiListaDescrizioneGeneriAssociateAdUnBrano(branoServiceInstance, genereServiceInstance);
			//testGeneriBrani(genereServiceInstance);
			testCercaPerDescrizioneConCaratteri(branoServiceInstance);
			...
			// testRimozioneBranoECheckGeneriAttraversoNativeSql(branoServiceInstance,
			// genereServiceInstance);
	...
	private static void testGeneriBrani(GenereService genereServiceInstance) throws Exception {
		System.out.println("....... testGeneriBrani inizio.............");
		List<Genere> result = genereServiceInstance.genereDiBraniPubblicatiInUnDeterminatoPeriodo(
				LocalDate.parse("2020-01-11"), LocalDate.parse("2021-09-23"));
		System.out.println(result);

	}

	private static void testCercaPerDescrizioneConCaratteri(BranoService branoServiceInstance) throws Exception {
		List<Brano> result = branoServiceInstance.cercaPerDescrizione();
		System.out.println(result);
	}
